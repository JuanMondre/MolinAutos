...
// Middleware para proteger el acceso al área de administración
...
app.get('/login', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'login.html')); // Usa path.join para resolver la ruta correctamente
});

app.post('/login', passport.authenticate('local', {
  successRedirect: '/admin', // Redirige al área de administración si el inicio de sesión es exitoso
